...
os.chdir("/home/oguz/Downloads/SALOME-8.3.0-UB16.04/BINARIES-UB16.04/GUI/share/salome/plugins/gui/salome-kratos-plugin/examples/2D_cantilever")
cur_dir=os.chdir
print(cur_dir)
...
solver_module=__import__('structural_mechanics_static_solver') ## now it works but why it wasnt working before is a mystery
#-----OGUZ SETTINGS END
